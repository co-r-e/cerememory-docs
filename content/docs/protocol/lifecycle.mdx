...
- **Line 1** — `ArchiveHeader` (`version`, `timestamp`, `record_count`, optional `curated_record_count`, optional `raw_record_count`)
...
- **Last line** — `ArchiveFooter` carrying a SHA-256 hex digest of the record lines.
