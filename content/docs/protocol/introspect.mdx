...
<LinkCard href="/docs/reference/api-endpoints" title="API Endpoints" description="Invoke these operations over HTTP" />
<LinkCard href="/docs/reference/cli" title="CLI Reference" description="Invoke these operations from the CLI" />
